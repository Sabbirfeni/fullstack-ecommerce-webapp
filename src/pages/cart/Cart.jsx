    ...
    {cartItem.length > 0 ? (
      <div className='flex justify-between w-full flex-col lg:flex-row gap-2 md:gap-3'>
        {cartItem.map((item, index) => {
          ...
          return (
            <div key={`${title}-${index}`} className='cart-item-container w-full lg:w-2/3 grid xl:grid-cols-2 grid-cols-1 gap-2 md:gap-3'>
              <div className='cart-item bg-slate-300 w-full flex rounded-md overflow-hidden shadow-md'>
        ...
        <div className='price-calculator bg-slate-300 w-full lg:w-1/3'>
          calculator
        </div>
      </div>
    ) :
            ...
            <div className="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0 ">
              <div className="rounded-lg md:w-2/3">
                ...
                <div className="flex justify-between mb-3">
                  ...
                  <div>
                    <p className="mb-1 text-lg font-bold" style={{ color: mode === 'dark' ? 'white' : '' }}>₹{groundTotal}</p>
                  </div>
                </div>*/}
                {/* <Modal  /> */}
