        ...
        <div className="filter-options flex-1 flex items-center gap-2 gap-md-5">
          ...
          <FormControl sx={{ width: { xs: "100px", md: "150px" } }}>
            <InputLabel
              ...
              size="small"
              sx={{ fontSize: { xs: "13px", md: "14px" }, marginTop: "3px" }}
            >
              Catergory
            </InputLabel>
            <Select
          ...
          <FormControl sx={{ width: { xs: "85px", md: "150px" } }}>
            <InputLabel
              ...
              color="secondary"
              size="small"
              sx={{ fontSize: { xs: "12px", md: "14px" }, marginTop: "3px" }}
            >
              Budget
            </InputLabel>
            <Select
            ...
            >
              <MenuItem value="1000" sx={{ fontSize: "14px" }}>
                1,000
              </MenuItem>
              <MenuItem value="5000" sx={{ fontSize: "14px" }}>
                5,000
              </MenuItem>
              <MenuItem value="10000" sx={{ fontSize: "14px" }}>
                10,000
              </MenuItem>
              <MenuItem value="20000" sx={{ fontSize: "14px" }}>
                20,000
              </MenuItem>
              <MenuItem value="30000" sx={{ fontSize: "14px" }}>
                30,000
              </MenuItem>
              <MenuItem value="50000" sx={{ fontSize: "14px" }}>
                50,000
              </MenuItem>
            </Select>
          </FormControl>
